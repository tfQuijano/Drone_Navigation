...
class PosePublisher:
    def __init__(self):
        ...
        self.start_position.pose.position.z = 0.3
        ...
        # setup x_wp, z_wp as a list of points in a loop
        x_wp = -0.2
        y_wp = -0.2
        z_wp = 1.15
        y_step = 0.25
        ...
        for wp_no in range(0,4):
            ...
            wp_a.pose.position.x = x_wp     #x_wp does not change in this loop
            wp_a.pose.position.y = y_wp     #new y_wp
            wp_a.pose.position.z = z_wp
            ...
            wp_a.pose.position.x = x_wp
            wp_a.pose.position.y = y_wp
            wp_a.pose.position.z = z_wp #new z_wp
